    ...
    <div>
      ...
      <div className="mb-8 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 bg-[#2d6a1e] rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <div>
            <div
              className="prose prose-green max-w-none text-sm text-gray-700 leading-relaxed
                [&_h3]:font-bold [&_h3]:text-[#2d6a1e] [&_h3]:mb-1
            ...
            <Link
              to="/ueber-uns"
              className="inline-flex items-center gap-1 text-sm text-[#2d6a1e] font-semibold hover:text-[#1a4d0f] mt-2 no-underline"
            >
      ...
      {!latestPost && (
        <div className="bg-white rounded-xl shadow-md p-8 text-center text-gray-500">
          ...
          <Link to="/admin" className="inline-block mt-4 text-[#2d6a1e] font-semibold hover:underline">
            Zum Admin-Bereich →
          </Link>
        </div>
      )}
      ...
      {/* Latest Post */}
      {latestPost && <article className="bg-white rounded-xl shadow-md overflow-hidden mb-8">
      ...
      {content.posts.length > 1 && (
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="bg-[#2d6a1e] px-6 py-3">
            ...
            {content.posts.slice(1).map((post) => (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 hover:text-[#2d6a1e] transition-colors">
                      {post.title}
                    </h4>
